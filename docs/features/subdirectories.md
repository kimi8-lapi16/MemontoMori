...
設定パネル上部のフォルダピッカー、または左ペインの[フォルダツリー](./folder-sidebar.md)で対象を選びます。
...
`新規フォルダを作成` ボタンで、現在のフォルダ内に子フォルダを作って即移動できます。階層が増えてきたら、左ペインの[フォルダツリー](./folder-sidebar.md)を開くとワンクリックで行き来できます。
